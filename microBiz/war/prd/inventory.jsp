...
<div class="row">
	...
	<form role="form" method="post" action="${f:url('/prd/inventoryAction')}">
		<div class="col-lg-6">
		...
		<div class="col-lg-6">
			...
			<div class="form-group input-group">
				<span class="input-group-addon">Default Purchase Consume
					Ratio</span> <input type="text" ${f:text("purchaseConsumeRatio1")}
					class="form-control" />
			</div>

			<div class="form-group input-group">
				<span class="input-group-addon">Default Ratio Description</span> <input
					type="text" ${f:text("purchaseConsumeRatio1Desc")}
					class="form-control" />
			</div>

			<div class="form-group input-group">
				<span class="input-group-addon">Second Purchase Consume Ratio</span>
				<input type="text" ${f:text("purchaseConsumeRatio2")}
					class="form-control" />
			</div>

			<div class="form-group input-group">
				<span class="input-group-addon">Second Ratio Description</span> <input
					type="text" ${f:text("purchaseConsumeRatio2Desc")}
					class="form-control" />
			</div>

			<div class="form-group input-group">
				<span class="input-group-addon">Third Ratio </span> <input
					type="text" ${f:text("purchaseConsumeRatio3")} class="form-control" />
			</div>

			<div class="form-group input-group">
				<span class="input-group-addon">Third Ratio Description</span> <input
					type="text" ${f:text("purchaseConsumeRatio3Desc")}
					class="form-control" />
			</div>
