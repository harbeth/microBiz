...
var prdRatioData = {
    ...
    , registerAddNewRowEvent: function() {
		...
		$("a[link=addRow]").click(function(){
			...
			var trCtrl = $("table[name=prdRatioTbl] tbody tr:last");
    	...
    	, registerRemoveBtnEvent: function() {
    		$("a[link=removeRow]").click(function(){
	...
	<table name="prdRatioTbl" class="table">
		...
		<tbody>
			<c:forEach items="${prdRatios}" var="pr" varStatus="status">
				...
				<td><input class="form-control input-sm" name="ratioDescs" value="${f:h(pr.desc)}" /></td>
				<td><input class="form-control input-sm" name="ratios" value="${f:h(pr.ratio)}" /></td>
			...
			<tr rowIndex="-1">
				...
				<td><input class="form-control input-sm" name="ratioDescs" value="" /></td>
				<td><input class="form-control input-sm" name="ratios" value="" /></td>
				
				<td class="text-center">
					<a link="removeRow" data-toggle="tab" aria-expanded="false" class="btn btn-info btn-sm" role="button">Remove Row</a>
				</td>
			</tr>
		</tbody>
		</table>
